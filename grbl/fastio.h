...
/*
	...
	2014/10/29 Added part to PiBot MOTHERBOARD value 	
*/
#ifndef	_ARDUINO_H
#define	_ARDUINO_H
...
///////*********check PORT 
#define     _GET_PORT(IO)       ((bool)(DIO ##  IO ## _WPORT & MASK(DIO ## IO ## _PIN) ))       
//////*************

///////*********check PCINT pin interrupt set
#define     _SET_INT_INPUT(IO)   do {DIO ##  IO ## _PCINT |= MASK(DIO ## IO ## _PIN); } while (0)      
//////*************
...
///////*********check PCINT pin interrupt set
#define     SET_INT_INPUT(IO)     _SET_INT_INPUT(IO) 
//////*************
...
//////////////////////////////####################********************
#define SERIAL_RX USART0_RX_vect
#define SERIAL_UDRE USART0_UDRE_vect   ////****serial Port not changed
//////////////////////////////###################********************
...
#define DIO0_PWM		NULL
#define DIO0_PCINT      PCMSK1   //////***add input interrup
...
#define DIO10_PCINT     PCMSK0   //////***add input interrup

#define	DIO11_PIN		PINB5
#define	DIO11_RPORT	PINB
#define	DIO11_WPORT	PORTB
#define	DIO11_DDR		DDRB
#define DIO11_PWM		&OCR1AL  //NULL
#define DIO11_PCINT     PCMSK0   //////***add input interrup

#define	DIO12_PIN		PINB6
#define	DIO12_RPORT	PINB
#define	DIO12_WPORT	PORTB
#define	DIO12_DDR		DDRB
#define DIO12_PWM		&OCR1BL  //NULL
#define DIO12_PCINT     PCMSK0   //////***add input interrup

#define	DIO13_PIN		PINB7
#define	DIO13_RPORT	PINB
#define	DIO13_WPORT	PORTB
#define	DIO13_DDR		DDRB
#define DIO13_PWM		&OCR0A   ///***?  &OCR1CL 
#define DIO13_PCINT     PCMSK0   //////***add input interrup
...
#define DIO14_PWM		NULL
#define DIO14_PCINT     PCMSK1   //////***add input interrup
...
#define DIO15_PWM		NULL
#define DIO15_PCINT      PCMSK1   //////***add input interrup
...
#define DIO50_PCINT     PCMSK0   //////***add input interrup
...
#define DIO51_PCINT     PCMSK0   //////***add input interrup
...
#define DIO52_PCINT     PCMSK0   //////***add input interrup
...
#define DIO53_PCINT     PCMSK0   //////***add input interrup
...
#define DIO62_PCINT     PCMSK2   //////***add input interrup
...
#define DIO63_PCINT     PCMSK2   //////***add input interrup
...
#define DIO64_PCINT     PCMSK2   //////***add input interrup
...
#define DIO65_PCINT     PCMSK2   //////***add input interrup
...
#define DIO66_PCINT     PCMSK2  //////***add input interrup
...
#define DIO67_PCINT     PCMSK2  //////***add input interrup
...
#define DIO68_PCINT     PCMSK2  //////***add input interrup
...
#define DIO69_PCINT     PCMSK2   //////***add input interrup

/////################*********** added  undefined in ardunio
...
#define DIO72_PCINT      PCMSK1   //////***add input interrup
...
#define DIO73_PCINT      PCMSK1   //////***add input interrup
...
#define DIO74_PCINT      PCMSK1   //////***add input interrup
...
#define DIO75_PCINT      PCMSK1   //////***add input interrup
...
#define DIO76_PCINT      PCMSK1   //////***add input interrup
...
#define DIO77_PCINT      PCMSK1   //////***add input interrup
...
#define DIO78_PCINT      PCMSK1   //////***add input interrup
...
/////##########****** added  undefined in ardunio
///////****seconde io style  with PORT name
...
#define PG5_DDR			DDRG
#define PG5_PWM			&OCR0B  /////************this defined
#undef PG6
