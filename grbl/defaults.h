...
#define defaults_h
  ...
  #define DEFAULT_Z_STEPS_PER_MM 2560.0
  #define DEFAULT_X_MAX_RATE 1800.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 1800.0 // mm/min
  ...
  #define DEFAULT_Z_MAX_TRAVEL 120.0 // mm
